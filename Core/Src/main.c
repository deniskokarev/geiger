...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIO_CTL_GPIO_Port, GPIO_CTL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PA0 GEIGER_EXTI_NEW_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_0|GEIGER_EXTI_NEW_Pin;
  ...
  /*Configure GPIO pin : GEIGER_EXTI_Pin */
  GPIO_InitStruct.Pin = GEIGER_EXTI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GEIGER_EXTI_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : GPIO_CTL_Pin */
  GPIO_InitStruct.Pin = GPIO_CTL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIO_CTL_GPIO_Port, &GPIO_InitStruct);
